...
export default async function Home() {
  const popularCoursesPromise: Promise<popularCourse[] | { error: string }> =
    getPopularCourses();
  const popularCategoriesPromise: Promise<
    popularCategory[] | { error: string }
  > = getPopularCategories();
  const [popularCourses, popularCategories] = await Promise.all([
    popularCoursesPromise,
    ...
    <div className=" bg-white w-full pb-10 lg:pb-14 ">
          ...
          <div className="flex justify-center flex-col items-center gap-8">
            ...
            <div className="max-w-lg">
              <p className="text-center">
                Choose the categories that best suit your interests and needs.
                Your selections will help us tailor content and recommendations
                specifically for you, ensuring a more personalized experience.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-3">
              {popularCategories.map((popular_category) => (
                <Link
                  href={`/category/${popular_category.slug}`}
                  key={popular_category.id}
                  className="rounded-xl flex flex-col justify-between gap-6 bg-gray-50 px-4 py-3 shadow overflow-hidden"
                >
      ...
      <div className="mt-20 lg:mt-32 container">
        <div className="flex justify-center flex-col items-center gap-8">
          ...
          <div className="max-w-lg">
            <p className="text-center">
              Discover why students and parents love our flexible, engaging K-12
              courses. See their success stories and join our community today!
            </p>
          </div>
