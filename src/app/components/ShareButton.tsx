...
const ShareButton: React.FC<ShareButtonProps> = ({ title, url }) => {
  ...
  const handleCopy = (event: React.MouseEvent) => {
    ...
    // Set a timer to trigger menu close after 2 seconds
    setTimeout(() => {
      setShouldClose(true);
    }, 500);
  };
          ...
          <>
            ...
            <MenuItems anchor="bottom end" className={"origin-top-left flex flex-col bg-white drop-shadow-2xl border rounded-md min-w-[200px] transition duration-200 ease-out data-[closed]:scale-95 data-[closed]:opacity-0"} transition>
              <MenuItem>
                <div
                  onClick={handleCopy}
                  className="border-b group cursor-pointer gap-3 flex items-center px-5 py-3 data-[focus]:bg-blue-100"
                >
              ...
              <MenuItem>
                <WhatsappShareButton
                  ...
                  title={title}
                  separator=":: ">
                  <div className='cursor-pointer group gap-3 flex items-center px-5 py-3 data-[focus]:bg-blue-100'>
                    ...
                    <p className='text-sm text-gray-700 group-hover:text-black'>Share on Whatsapp</p>
                  </div>
                </WhatsappShareButton>
              </MenuItem>
              ...
              <MenuItem>
                <FacebookShareButton
                  ...
                  quote={title}
                >
                  <div className='cursor-pointer gap-3 group flex items-center px-5 py-3 data-[focus]:bg-blue-100'>
                    <div className='w-[24px] h-[24px]'>
                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 30 30">
                        <path d="M15,3C8.373,3,3,8.373,3,15c0,6.016,4.432,10.984,10.206,11.852V18.18h-2.969v-3.154h2.969v-2.099c0-3.475,1.693-5,4.581-5 c1.383,0,2.115,0.103,2.461,0.149v2.753h-1.97c-1.226,0-1.654,1.163-1.654,2.473v1.724h3.593L19.73,18.18h-3.106v8.697 C22.481,26.083,27,21.075,27,15C27,8.373,21.627,3,15,3z"></path>
                      </svg>
                    </div>
                    <p className='text-sm text-gray-700 group-hover:text-black'>Share on Facebook</p>
                  </div>
                </FacebookShareButton>
              </MenuItem>
              <MenuItem>
                <TwitterShareButton
                  ...
                  <div className='cursor-pointer group gap-3 flex items-center px-5 py-3 data-[focus]:bg-blue-100'>
                    ...
                    <p className='text-sm text-gray-700 group-hover:text-black'>Share on X</p>
                  </div>
                </TwitterShareButton>
              </MenuItem>
              <MenuItem>
                <LinkedinShareButton
                  ...
                  <div className='cursor-pointer group gap-3 flex items-center px-5 py-3 data-[focus]:bg-blue-100'>
                    ...
                    <p className='text-sm text-gray-700 group-hover:text-black'>Share on LinkedIn</p>
                  </div>
                </LinkedinShareButton>
              </MenuItem>
